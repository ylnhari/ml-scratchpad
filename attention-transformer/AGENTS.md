# Attention Transformer learning instructions
...
3. No auto-commit.
4. Learner journey first. No app scaffolding. Visuals live inline in the notebook, not a separate figure script. See parent `../AGENTS.md` for governing principles.
